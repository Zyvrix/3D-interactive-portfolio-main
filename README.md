![Portfolio Preview](https://github.com/zyvrix/3D-interactive-portfolio-main/blob/main/public/assets/seo/og-image.png?raw=true)
...
### Live preview: https://dineshydv.vercel.app
...
1. Clone this repository:
   ```bash
   git clone https://github.com/zyvrix/3D-interactive-portfolio-main.git
   ```
...
This project is deployed using **Vercel** for its blazing-fast performance and ease of use. You can view the live site [here](https://dineshydv.vercel.app/).
